...
{
ADReal
secondaryElectronEnergyActualMeanEnergy(const ADReal & log_actual_mean_energy,
                                        const bool clamp,
...
SecondaryElectronEnergyBC::computeQpResidual()
{
  ...
  const ADReal actual_mean_energy =
      secondaryElectronEnergyActualMeanEnergy(_u[_qp] - _em[_qp],
