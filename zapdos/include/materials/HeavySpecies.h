...
protected:
  ...
  /// If true, calculate mobility from a reduced mobility and local gas pressure
  const bool _use_reduced_mobility;
  /// Reduced mobility at the reference gas density
  const Real _reduced_mobility;
  /// Reference pressure for reduced mobility scaling
  const Real _reduced_mobility_reference_pressure;
  /// Reference temperature for reduced mobility scaling
  const Real _reduced_mobility_reference_temperature;
