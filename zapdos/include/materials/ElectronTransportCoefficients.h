...
protected:
  ...
  /// True if the electron transport interpolation energy is limited to a bounded interval
  const bool _clamp_actual_mean_energy;
  /// Lower bound for actual mean electron energy used in transport interpolation
  Real _actual_mean_energy_min;
  /// Upper bound for actual mean electron energy used in transport interpolation
