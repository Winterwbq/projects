# Cu PVD hybrid Zapdos input — B-guided nonlocal top-target SEE in axisymmetric R-Z geometry.
...
#
# The consolidated SEE-map generators now support only the original effective
# Cu density. This older low-density comparison input is retained but is not
# part of the current map-generation workflow.
#
# The default below selects the image-3092 four-coil B field and its paired
# source map. Invoke Zapdos from the cu_pvd_hybrid_2d/ root:
#   /Users/bingqingwang/projects/zapdos/zapdos-opt \
#     -i zapdos_templates/cu_pvd_hybrid_see_30cm_b_guided.i
#
# Source-only override (the B and source directories must remain paired):
#   /Users/bingqingwang/projects/zapdos/zapdos-opt \
#     -i zapdos_templates/cu_pvd_hybrid_see_30cm_b_guided.i \
#     bfield_table_dir=../runs/zapdos_hpem_rz_30cm_reference_source_only/moose_tables \
#     guided_source_table_dir=../runs/zapdos_b_guided_see_30cm/source_only/moose_tables
#
# Original four-coil override:
#   /Users/bingqingwang/projects/zapdos/zapdos-opt \
#     -i zapdos_templates/cu_pvd_hybrid_see_30cm_b_guided.i \
#     bfield_table_dir=../runs/zapdos_hpem_rz_30cm_reference_four_coil/moose_tables \
#     guided_source_table_dir=../runs/zapdos_b_guided_see_30cm/four_coil/moose_tables
#
...
guided_source_table_dir = '../runs/zapdos_b_guided_see_30cm/four_coil_img3092/moose_tables'
...
[Functions]
  ...
  # Offline B-guided fast-electron deposition weight [m^-1]. Its
  # axisymmetric volume integral equals the target area, so this map changes
  # the source distribution without changing its integrated amplitude.
  [see_spatial_weight]
    type = PiecewiseMultilinear
    data_file = '${guided_source_table_dir}/see_spatial_weight_m-1.tbl'
  []
