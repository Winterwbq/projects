...
#
# Before running, generate the neutral/rate tables and source-only
# reference magnetic-field tables:
#   python scripts/generate_hpem_rz_30cm_tables.py
#   python scripts/generate_reference_source_bfield.py
#
# Then invoke Zapdos from the cu_pvd_hybrid_2d/ root:
#   /Users/bingqingwang/projects/zapdos/zapdos-opt \
#     -i zapdos_templates/cu_pvd_hybrid_top_target_see_rf_30cm_source_only_bfield.i
#
...
table_dir      = '../runs/zapdos_hpem_rz_30cm_source_only_bfield/moose_tables'
